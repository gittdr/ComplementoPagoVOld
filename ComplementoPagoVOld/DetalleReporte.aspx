<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetalleReporte.aspx.cs" Inherits="ComplementoPagoVOld.DetalleReporte" %>
...
<body class="bg-muted">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
                  ...
                  <div class="card-header">
                      <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>Reporte por complemento - </label>
                      ...
                      <asp:Button Text="Descargar" CssClass="btn btn-danger" OnClick="ExportExcel" runat="server"/>
                                    </div>
                                </div>
    ...
    margin-top: 60vh;background:rgba(0, 25, 61, 0.9) !important;">

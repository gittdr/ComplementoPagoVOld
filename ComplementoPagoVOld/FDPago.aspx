<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FDPago.aspx.cs" Inherits="ComplementoPagoVOld.FDPago" %>
     ...
     <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        ...
        <asp:HyperLink ID="HyperLink5" CssClass="text-white" Style="text-decoration:none;padding-right: 20px;"  runat="server" NavegateUrl="QFListado.aspx" NavigateUrl="~/QFListado.aspx"> &nbsp;<i class="fa fa-trash" aria-hidden="true"></i> Papelera</asp:HyperLink>
         ...
         <li class="nav-item">
        <asp:HyperLink ID="HyperLink6" CssClass="text-white" Style="text-decoration:none;padding-right: 20px;"  runat="server" NavegateUrl="FDPago.aspx" NavigateUrl="~/FDPago.aspx"> &nbsp;<i class="fa fa-plus-square" style="color:#f2c43e" aria-hidden="true"></i> Forma de Pago</asp:HyperLink>
      </li>
         <li class="nav-item">
